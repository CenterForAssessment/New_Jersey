...
New_Jersey_Data_LONG_2016 <- New_Jersey_Data_LONG_2016[!is.na(SCALE_SCORE)]
...
New_Jersey_Data_LONG_2016[which(GRADE %in% c(NA,1,2,12)), VALID_CASE := "INVALID_CASE"] #  11th grade ELA not used, but leave it Valid just in case.
New_Jersey_Data_LONG_2016[which(GRADE %in% 9:11 & CONTENT_AREA == "MATHEMATICS"), VALID_CASE := "INVALID_CASE"]
...
setkey(New_Jersey_Data_LONG_2016, VALID_CASE, CONTENT_AREA, GRADE, ID, SCALE_SCORE)
setkey(New_Jersey_Data_LONG_2016, VALID_CASE, CONTENT_AREA, GRADE, ID)
# sum(duplicated(New_Jersey_Data_LONG_2016[VALID_CASE != "INVALID_CASE"])) # 10 duplicates with valid SSIDs -- all have same SSID and esID, so appear valid - take the highest score
# dups <- data.table(New_Jersey_Data_LONG_2016[unique(c(which(duplicated(New_Jersey_Data_LONG_2016))-1, which(duplicated(New_Jersey_Data_LONG_2016)))), ], key=key(New_Jersey_Data_LONG_2016))
New_Jersey_Data_LONG_2016[which(duplicated(New_Jersey_Data_LONG_2016))-1, VALID_CASE := "INVALID_CASE"]


#  Still 3 kids with duplicates if Grade ignored -- take highest score again ...
setkey(New_Jersey_Data_LONG_2016, VALID_CASE, CONTENT_AREA, ID, SCALE_SCORE)
